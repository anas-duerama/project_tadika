...
<body class="bg-gray-100 text-gray-800">
  ...
  <!-- HEADER (ไม่ใส่ปุ่มบนขวา ตามที่เคยขอ) -->
  <header class="h-16 bg-white border-b border-gray-200 flex items-center px-4 md:px-6">
    <h1 class="font-bold">แก้ไขข่าวสาร</h1>
  </header>
