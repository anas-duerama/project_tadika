...
<body class="bg-gray-50 text-gray-800">
  ...
  <!-- HEADER -->
<header class="bg-sky-200 border-b border-sky-300 shadow-sm">
  <div class="max-w-6xl mx-auto h-16 px-4 md:px-6 flex items-center justify-between">
    <div class="flex items-center gap-3">
      <a href="{{ $adminHome }}"
         class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-sky-400 hover:bg-sky-500 text-sky-900">
        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
        </svg>
        กลับหน้า Admin
      </a>
      <h1 class="text-lg md:text-xl font-extrabold text-gray-900">เพิ่มข้อมูลนักเรียน</h1>
    </div>
  </div>
</header>
